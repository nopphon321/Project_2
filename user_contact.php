...
<?php include("public/header.php") ; ?>
    ...
    <section class="breadcumb-area bg-img d-flex align-items-center justify-content-center" style="background-image: url(public/img/bg-img/bg-8.jpg);">
    ...
    <!-- ##### Contact Area Start ##### -->
    <section class="contact-information-area mt-5 pt-5">
        <div class="container">
            <div class="row">
